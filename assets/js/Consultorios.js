$(document).ready(function () {
    ...
    function PacienteAgregado(info,ce, medico,TieneInterconsulta) {
        bootbox.confirm({
            title: "<h5>PACIENTE ASIGNADO O DADO DE ALTA</h5>",
    ...
    function AjaxAgregarConsultorio(info) {
        bootbox.confirm({
            title: "<h5>N° DE PACIENTE NO ENCONTRADO</h5>",
            message: '<div class="row" style="margin-top:-10px">'+
                        '<div class="col-md-12 ">'+
                            '<div style="height:10px;width:100%;margin-top:10px" class="'+ColorClasificacion(info.triage_color)+'"></div>'+
                        '</div>'+
                        '<div class="col-md-12">'+
                            ...
                            '<h5 style="margin-top:-5px"><b>EL N° DE PACIENTE NO ENCONTRADO. ¿DESEA AGREGAR ESTE PACIENTE A ESTE CONSULTORIO?</b></h5>'+
                        '</div>'+
                    '</div>',
            buttons: {
                cancel: {
