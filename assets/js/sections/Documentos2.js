...
//                        }
    ...
    $("#add_otro_residente").click (function(e) {
        cont += 1;
        $("ol").append('<li><input id="medico' + cont + '" type="text" name="nombre_residente[]" placeholder="Nombre(s)">&nbsp;&nbsp;' +
                            '<input id="medico' + cont + '" type="text" name="apellido_residente[]" placeholder="Apellidos">&nbsp;&nbsp;'+            
                            '<input id="medico' + cont + '" type="text" name="cedula_residente[]" placeholder="Cédula Profesional">&nbsp;&nbsp;'+
                            '<a href="#" class="btn btn-danger delete btn-xs" id="quitar_residente"><span class="glyphicon glyphicon-remove"></span></a>'+
                         '</li>'); 
