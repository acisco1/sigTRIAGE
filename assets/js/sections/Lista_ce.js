        ...
        $.ajax({
            ...
            data:{
                ...
                if(data.TOTAL_LISTA==0){
                    $('.consultoriosespecialidad_last_lista tbody tr').html('<td colspan="4" style="border: none!important"><h2 style="font-size: 41px;text-align: center;font-weight: bold;margin-top: 40px;">UMAE | Dr. Victorio de la Fuente Narváez<br></h2></td>');
                }else{
