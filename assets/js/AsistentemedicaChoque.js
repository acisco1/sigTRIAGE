$(document).ready(function (e) {
    ...
    $('.agregar-horacero-paciente').on('click',function(e){
        e.preventDefault();
        bootbox.confirm({
            title:'<h5>TIPO DE PACIENTE</h5>',
            message:'<div class="row">'+
                '<div class="col-md-12">'+
                    '<div class="form-group">'+
                        '<select class="form-control" id="triage_tipo_paciente" name="triage_tipo_paciente">'+
                ...
                '<div class="col-md-12">'+
                    '<div class="form-group form-espontaneo form-no-identificado ">'+
                        '<input name="pia_procedencia_espontanea_lugar" type="text" placeholder="Lugar de Procedencia"  class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-6">'+
                ...
                '<div class="col-md-6">'+
                    '<div class="form-group form-identificado hide">'+
                        '<input name="triage_nombre_ap"  type="text" placeholder="Apellido Paterno"  class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-6">'+
                    '<div class="form-group form-identificado hide">'+
                        '<input name="triage_nombre_am"  type="text" placeholder="Apellido Materno"  class="form-control">'+
                    '</div>'+
                '</div>'+
                '<div class="col-md-12">'+
                    '<div class="form-group form-identificado hide">'+
                        '<input name="triage_nombre"  type="text" placeholder="Nombre del Paciente"  class="form-control">'+
                    '</div>'+
                    '<div class="form-group form-no-identificado ">'+
                        '<input name="triage_nombre_pseudonimo" type="text" placeholder="Pseudonimo del Paciente"  class="form-control">'+
                    '</div>'+
                    '<div class="form-group form-identificado hide">'+
                    ...
                    '<div class="form-group form-identificado-nss hide">'+
                        '<div class="row">'+
                            '<div class="col-md-6" style="padding-right:2px">'+
                                '<input name="pum_nss" type="text" placeholder="N.S.S"  class="form-control">'+
                            '</div>'+
                            '<div class="col-md-6" style="padding-left:2px">'+
                                '<input name="pum_nss_agregado" type="text" placeholder="N.S.S AGREGADO"  class="form-control">'+
                            '</div>'+
                        '</div>'+
                    '</div>'+
                    ...
                    '</div>'+
                    '<div class="form-group">'+
                        '<input name="triage_fecha_nac_a" type="text" placeholder="Año de Nac. Ejemplo: 2015"  class="form-control dd-mm-yyyy">'+
                    '</div>'+
                '</div>'+
            '</div>',
