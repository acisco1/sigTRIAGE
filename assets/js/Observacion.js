            ...
            bootbox.dialog({
                ...
                message:'<div class="row ">'+
                            '<div class="col-sm-12">'+
                                ...
                                '<input type="radio" name="observacion_alta_value" value="Alta e ingreso a Choque" id="choque"><label for="choque"><p class="text-danger">&nbsp;&nbsp;Ingreso área de choque</p></label><br>'+
