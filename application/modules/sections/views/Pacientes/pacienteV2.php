                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <i class="fa fa-print icono-accion tip pointer" onclick="AbrirDocumento(base_url+'Inicio/Documentos/HojaFrontalCE/<?=$value['triage_id']?>')" data-original-title="Imprimir Hoja Frontal Emitido por Consultorios u Observación"></i>
                                        <?php }?>
                                    </td>
                                </tr>
                                <?php }?>
