                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="empleado_matricula" readonly=""  value="<?=$info[0]['empleado_matricula']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="mayus-bold"><b>NOMBRE</b></label>
                                            <input class="form-control" name="empleado_nombre" required=""  value="<?=$info[0]['empleado_nombre']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="mayus-bold">APELLIDOS</label>
                                            <input class="form-control" name="empleado_apellidos"   value="<?=$info[0]['empleado_apellidos']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group" >
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="empleado_categoria"  value="<?=$info[0]['empleado_categoria']?>">
                                        </div> 
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label  class="mayus-bold"><b>DEPARTAMENTO</b></label>
                                            <input class="form-control" name="empleado_departamento" value="<?=$info[0]['empleado_departamento']?>">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
