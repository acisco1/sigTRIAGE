...
<div class="box-row">
    <div class="box-cell">
                                ...
                                <div class="col-md-6" style="margin-top: -10px">
                                    <div class="form-group">
                                        <div class="input-group m-b">
                                            ...
                                            <select name="notas_tipo" class="form control select2 width100" data-value="<?=$Nota['notas_tipo']?>" required>
                                                <option value=""></option>
       ...
       <!-- COMIENZA LOS CAMPOS DEL FORMULARIO PARA LA NOTA MEDICA -->           
                ...
                <div class="col-sm-12 nota_motivoInterconsulta hidden">
                       ...
                       <div class="col-md-12">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group" >
                                        ...
                                        <label class="md-check">
                                            <input type="radio" name="residente" value="Si" data-value="<?=$Nota['notas_esresidente']?>">
                                            <i class="blue"></i>Si
                                        </label>&nbsp;&nbsp;&nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="residente" value="No" checked="">
                                            <i class="blue"></i>No
                                        </label>  
                         ...
                         <div class="col-sm-12 medico_residente hidden">
                           
                            <ol><li><input id="nombre_residente" type="text" name="nombre_residente[]" placeholder="Nombre(s)" value="<?=$MedicoResidente['nombre_residente']?>">&nbsp;
                                    <input id="apellido_residente" type="text" name="apellido_residente[]" placeholder="Apellidos" value="<?=$MedicoResidente['apellido_residente']?>">&nbsp;
                                    <input id="cedula" type="text" name="cedula_residente[]" placeholder="Cédula Profesional" value="<?=$MedicoResidente['cedulap_residente']?>">&nbsp;
                                    <a href='#' class="btn btn-success btn-xs" id="add_otro_residente"><span class="glyphicon glyphicon-plus"></span></a>
                                </li>
                            </ol>
                       
                        </div>        
                            <div class="row">
                                <div class="col-sm-3 <?=$_GET['inputVia']=='Médico Torres Hospitalización' ? '':'hide'?>"> 
                                    <div class="form-group" >
                                        <label class="mayus-bold">ES MÉDICO RESIDENTE</label>&nbsp;&nbsp;&nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="es_residente" value="Si" data-value="<?=$Nota['notas_medicotratante']?>">
                                            <i class="blue"></i>Si
                                        </label>&nbsp;&nbsp;&nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="es_residente" value="No" checked="">
                                            <i class="blue"></i>No
                                        </label>   
                                    </div>
