                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                           <label class="md-check">
                                            <input type="checkbox" class='sum' name="hf_glasgow_expontanea" value="4" data-value="<?=$hojafrontal[0]['hf_glasgow_expontanea']?>" class="has-value"><i class="indigo"></i>Expontánea</label>&nbsp;&nbsp;
                                            <label class="md-check">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="range" name="hf_eva" min="0" max="10" value=""><output name="x" for="hf_eva">=</output>
                                        </div>
                                   </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="hf_alta" data-value="<?=$hojafrontal[0]['hf_alta']?>" class="form-control">
                                                ...
                                                <option value="Envio a Corta Estancia">Observación corta estancia</option>
