            ...
            $col_md_3.='<div class="col-md-3" style="margin-top: 5px" >
                                <div class="row" >
                                    ...
                                    <div class="col-md-4 back-imss" style="height:95px;padding-left:2px">
                                        ...
                                        <h5 style="text-transform: uppercase;margin-top:8px;font-size:'.$font_ss.';text-align:center;line-height:1.5"><b>'.$value['doc_servicio_solicitado'].'</b></h5>
                                    ...
                                    <div class="col-md-7 back-imss" style="height:95px;font-size:12px;padding-left:2px;padding-right:2px;width:57%;">
                                        ...
                                        <h6 style="text-transform: uppercase;font-size:9px;line-height:1.6;margin-top:-8px;position:absolute;top:55px"><b>SERVICIO QUE ENVÍA: </b><br>'.$value['doc_servicio_envia'].'</h6>
