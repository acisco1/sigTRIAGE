                                    ...
                                    <div class="col-md-12" style="margin-top: 0px">
                                        <div  class="row">
                                            <div class="col-md-4">
                                                    ...
                                                    <input class="form-control" name="pum_nss" placeholder="" value="<?=$PINFO['pum_nss']?>"><span class="input-group-btn">
                                                    <button type="button" class="btn btn-secondary" data-toggle="modal" data-target='#ModalVigencia'>Verificar</button>  
                                                    </span>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog" id="modalTamanioG">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php 
                        echo form_open("Asistentesmedicas\VigenciaDerechos");
                        print_r($result);
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Aceptar</button>   
                        ...
                        <div class="row" style="padding: 14px;margin-top: -15px;margin-bottom: -35px;">
                            <div class="col-md-12 back-imss text-cente r">
                                    ...
                                    <div class="col-md-12"> 
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pia_tipo_atencion" data-value="<?=$PINFO['pia_tipo_atencion']?>" required>
                                            ...
                                            <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="pia_vigencia" data-value="<?=$PINFO['pia_vigencia']?>">
                                                                    <option value=""></option>
