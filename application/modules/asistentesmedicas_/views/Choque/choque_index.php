                    ...
                    <div class="row" style="margin-top: 0px">
                        ...
                        <div class="col-md-12">
                            <center>
                                ...
                                <a  md-ink-ripple="" class="agregar-horacero-paciente md-btn md-fab m-b red waves-effect " style="width: 150px;height: 150px;padding: 43px">
                            ...
                            <table class="table table-hover table-bordered footable" style="font-size: 13px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 12px"><?=$value['triage_horacero_f']?> <?=$value['triage_horacero_h']?></td>
