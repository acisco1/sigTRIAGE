            ...
            <div class="box-inner padding">
                <form class="solicitud-paciente">
                    <div class="panel panel-default " style="margin-top: -10px">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <h4 style="margin-top: -5px">
                                            ...
                                            ?> | <?=$info[0]['triage_paciente_sexo']?> 
                                               | <?=$PINFO['pia_procedencia_espontanea']=='Si' ? 'ESPONTANEA: '.$PINFO['pia_procedencia_espontanea_lugar'] : 'PROCEDENCIA: '.$PINFO['pia_procedencia_hospital'].' '.$PINFO['pia_procedencia_hospital_num']?> | <?=$info['triage_color']?>
                                        </h4>
                                    </div>
                                </div>
                            </span>
                        ...
                        <div class="row" style="padding: 14px;margin-top: -15px;margin-bottom: -35px;">
                            <div class="col-md-12 back-imss text-center">
                                <h5><b>PROCEDENCIA Y TIPO DE ATENCIÓN</b></h5>
                            </div>
                        </div>
                        <div class="panel-body b-b b-light">
                            <div class="card-body" style="padding-bottom: 0px">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pia_procedencia_espontanea" data-value="<?=$PINFO['pia_procedencia_espontanea']?>">
                                                        <option value="">SELECCIONAR PROCEDENCIA</option>
                                                        <option value="Si">EXPONTANEO</option>
                                                        <option value="No">REFERIDO</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="pia_procedencia_espontanea_lugar" data-value="<?=$PINFO['pia_procedencia_espontanea_lugar']?>">
                                                        <option value="">SELECCIONAR ATENCIÓN</option>
                                                        <option value="1.a VEZ">1.a VEZ</option>    
                                                        <option value="SUBSECUENTE">SUBSECUENTE</option>
                                                        <option value="NO DERECHOHABIENTE">NO DERECHOHABENTE</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label style="text-transform: uppercase;font-weight: bold">Vigencia</label>
                                                    <input class="form-control" name="pia_vigencia" placeholder="" value="<?=$PINFO['pia_vigencia']?>">
                                                </div> 
                                            </div>
                                            </div>
                                        </div>
