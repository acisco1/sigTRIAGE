...
<page backleft="0mm" backright="0mm" backtop="91.5mm">
    <page_header>
        <div style="position: absolute">
            <img src="<?=  base_url()?>assets/doc/4_30_6_.png" style="position: absolute;width: 100%">
            <div style="position: absolute;margin-left: 80px;margin-top: 80px;font-size: 10px">
                NE1 1 NOROESTE
            </div>
            <div style="position: absolute;margin-left: 140px;margin-top: 102px;font-size: 10px">
                351401200209
            </div>
            <div style="position: absolute;margin-left: 190px;margin-top: 120px;font-size: 10px">
                <?=$this->UM_CLASIFICACION?> | <?=$this->UM_NOMBRE?>
            </div>
            <div style="position: absolute;margin-left: 200px;margin-top: 83px;font-size: 8px"><?=  date('d/m/Y')?></div>
            <div style="position: absolute;margin-left: 258px;margin-top: 83px;font-size: 8px"><?=  $medico['empleado_matricula']?></div>
            <div style="position: absolute;margin-left: 400px;margin-top: 83px;font-size: 8px"></div>
            <div style="position: absolute;margin-left: 590px;margin-top: 83px;font-size: 8px">
                <?= Modules::run('Config/ObtenerTurno')?>
            </div>
            <div style="position: absolute;margin-left: 490px;margin-top: 81px;font-size: 9px;width: 45px;text-align: center">
                <?php 
            ...
            <div style="position: absolute;margin-left: 440px;margin-top: 102px;font-size: 9px;"><?=$medico['empleado_nombre']?> <?=$medico['empleado_apellidos']?></div>
        </div>
    </page_header>
    <div style="position: absolute;">
        <style>
