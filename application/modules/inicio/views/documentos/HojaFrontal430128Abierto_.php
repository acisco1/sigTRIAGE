...
<page backtop="80mm" backbottom="50mm" backleft="56" backright="15mm">
    <page_header>
        ...
        <div style="position: absolute;margin-top: 15px">
            ...
            <div style="position: absolute;margin-left: 437px;margin-top: 85px;width: 270px;text-transform: uppercase;font-size: 12px;">
            ...
            <div style="position: absolute;margin-left: 540px;margin-top: 105px;width: 270px;text-transform: uppercase;font-size: 11px;">
                <p style="margin-top: -2px">
            ...
            <div style="position: absolute;margin-left: 437px;margin-top: 180px;width: 270px;text-transform: uppercase;font-size: 11px;">
        ...
        <br>
        <?php }?>
        <h4 style="margin-bottom: -6px">PLAN Y ORDENES MÉDICAS</h4>
        A) <?=$hoja['hf_ayuno']?><BR>
        B) <?=$hoja['hf_signosycuidados']?><BR>
        C) <?=$hoja['hf_cuidadosenfermeria']?><BR>
        D) <?=$hoja['hf_solucionesp']?><BR>
        E) <?=$hoja['hf_medicamentos']?><BR>     
