                            ...
                            <table class="table table-hover table-bordered footable" data-page-size="10" data-filter="#filter_medico_choque" style="font-size: 13px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size: 10px"><?=$value['triage_nombre']=='' ? $value['triage_nombre_pseudonimo'] : $value['triage_nombre_ap'].' '.$value['triage_nombre_am'].' '.$value['triage_nombre']?> </td>
                                        <td>
                                            <?php 
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=  base_url()?>Sections/Documentos/Expediente/<?=$value['triage_id']?>/?tipo=Choque" target="_blank">
